...
public class StramEx {
	/*public static void main(String[] args) {
        ...
        intcityPopulationA = 500000;
        floatcityTempA = 15.50f;
 
        intcityIdB = 2;
        String cityNameB = "Salt Lake City";
        intcityPopulationB = 250000;
        floatcityTempB = 10.45f;
        ...
        try {
            ...
            //
            FileOutputStreamfos = new FileOutputStream("cities.dat");
            ...
            // readUTF(), etc.
            //
            FileInputStreamfis = new FileInputStream("cities.dat");
